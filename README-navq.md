...
| Item                   | Original                                    | New                                               |
| -----------------------| ------------------------------------------- | ------------------------------------------------- |
| imx-manifest repo URL  | https://github.com/nxp-imx/imx-manifest.git | https://github.com/NXPHoverGames/imx-manifest.git |
...
mkdir imx-yocto-bsp
cd imx-yocto-bsp
repo init -u https://github.com/NXPHoverGames/imx-manifest.git -b imx-linux-scarthgap -m imx-6.6.23-2.0.0-navq.xml
repo sync
```
...
pyocd flash -u JUDWF30NBDTWA -t mimx95_cm33 ./build/nxp_imx95_default/nxp_imx95_default.bin -f 10m
```
